...
Какие значения будут у _resultA_ и _resultB_ после выполнения следующего [кода](http://jsfiddle.net/STEVER/ZCKCE/)?
...
- [первый](http://jsfiddle.net/STEVER/nkRwU/)
- [второй](http://jsfiddle.net/STEVER/RVDTw/)
- [третий](http://jsfiddle.net/STEVER/Js8a6/)
...
Тут было сказано, что front-end разработчикам часто приходится сталкиваться с разбором кода на стороне сервера, поэтому вот вам вопрос на **JAVA**. Вопрос из себя представляет код, в котором реализован [Singleton](http://en.wikipedia.org/wiki/Singleton_pattern). И нужно сказать что может быть плохого в этом коде.
